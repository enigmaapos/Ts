  ...
  <div className="flex flex-col gap-4 text-sm">
    ...
    <div>
      ...
      <div className="flex flex-wrap gap-2">
        {[
	{ label: 'Bullish Trend', key: 'mainTrend', count: bullishMainTrendCount, color: 'text-green-300' },
          { label: 'Bearish Trend', key: 'mainTrend', count: bearishMainTrendCount, color: 'text-red-300' },

...
const greenVolumeCount = highestVolumeColorPrev.filter(c => c.volumeColor === 'green').length;
const redVolumeCount = highestVolumeColorPrev.filter(c => c.volumeColor === 'red').length;	

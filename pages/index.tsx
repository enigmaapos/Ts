    ...
    <div>
      ...
      <div className="flex flex-wrap gap-2">
        {[
          ...
          { label: 'BULLISH PULLBACK/ BUY', key: 'BULLISH PULLBACK/ BUY', count: signalCounts.bullishPullback, color: 'text-green-300' },
          { label: 'BEARISH PULLBACK/ SELL', key: 'BEARISH PULLBACK/ SELL', count: signalCounts.bearishPullback, color: 'text-red-300' },
...
>
  ...
  className={`px-1 py-0.5 min-w-[40px] text-center font-semibold ${
    signal.trim() === 'MAX ZONE'
      ...
      : signal.trim() === 'BULLISH PULLBACK/ BUY'
      ? 'text-green-400 font-bold'
      : signal.trim() === 'BEARISH PULLBACK/ SELL'
      ? 'text-red-400 font-bold'

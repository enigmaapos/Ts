  ...
  <div className="flex flex-col gap-4 text-sm">
    ...
    <div>
      ...
      <div className="flex flex-wrap gap-2">
        {[  { label: 'Bullish Trend', key: 'bullishMainTrend', count: bullishMainTrendCount ?? 0, color: 'text-green-300' },
  { label: 'Bearish Trend', key: 'bearishMainTrend', count: bearishMainTrendCount ?? 0, color: 'text-red-300' },
